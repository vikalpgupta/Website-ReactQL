        ...
        <div class="col-lg-6">
          <div class="box wow fadeInLeft">
            ...
            <p class="description">
              ...
              excepturi sint occaecati cupiditate non provident etiro rabeta
              lingo.
            </p>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          <div class="box wow fadeInLeft" data-wow-delay="0.2s">
            ...
            <p class="description">
              ...
              cillum dolore eu fugiat nulla pariatur trinige zareta lobur trade.
            </p>
          </div>
        </div>
        ...
        <div class="col-lg-6">
          <div class="box wow fadeInRight" data-wow-delay="0.2s">
            ...
            <p class="description">
              ...
              officia deserunt mollit anim id est laborum rideta zanox satirente
              madera
            </p>
          </div>
        </div>
